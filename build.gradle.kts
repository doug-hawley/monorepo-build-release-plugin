...
dependencies {
    ...
    add("unitTestImplementation", "io.kotest:kotest-runner-junit5:6.1.7")
    add("unitTestImplementation", "io.kotest:kotest-assertions-core:6.1.7")
    add("unitTestImplementation", "io.kotest:kotest-property:6.1.7")
    add("unitTestImplementation", "io.kotest:kotest-framework-datatest:6.1.7")
    add("unitTestImplementation", "io.mockk:mockk:1.13.13")

    // Integration test dependencies
    add("integrationTestImplementation", "io.kotest:kotest-runner-junit5:6.1.7")
    add("integrationTestImplementation", "io.kotest:kotest-assertions-core:6.1.7")
    add("integrationTestImplementation", "io.mockk:mockk:1.13.13")

    // Functional test dependencies
    add("functionalTestImplementation", gradleTestKit())
    add("functionalTestImplementation", "io.kotest:kotest-runner-junit5:6.1.7")
    add("functionalTestImplementation", "io.kotest:kotest-assertions-core:6.1.7")
}
